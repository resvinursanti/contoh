    ...
    <div class="wrapper">
        ...
        <form action="angsuranInsert">
            <div>
                ...
                %> <input type="text" name="idAngsuran" class="form-control" style="width:30%" value="<%= autoid%>01" readonly="true"/> <%
                } else {
            ...
            <div>
                ...
                <input type="date" name="tanggalAngsuran" value=""  class="form-control" style="width:30%" required="">
            </div>
            <div>
            ...
            <div>
                <label>Denda</label>
                <input type="number" name="denda" value=""  class="form-control" style="width:30%" required="">
            </div>
                <br>
            <div>
